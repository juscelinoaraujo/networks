...
Este projeto tem por objetivo explorar algumas propriedades da proteína 1TUP. O estudo dessa proteína permite entender como sequências específicas de DNA são reconhecidas e como mutações podem comprometer sua função, levando ao desenvolvimento de diversos tipos de câncer. Assim, o estudo da 1TUP é fundamental não apenas para compreender os mecanismos moleculares da supressão tumoral, mas também para o desenvolvimento de terapias anticâncer mais eficazes, direcionadas à restauração da atividade da p53 mutante ou ao fortalecimento de suas vias regulatórias ([Cho *et al.*, 1994](https://doi.org/10.1126/science.8023157), [Vouden & Prives, 2009](https://doi.org/10.1016/j.cell.2009.04.037) e [Levine, 1997](https://doi.org/10.1016/S0092-8674(00)81871-1)). Essa proteína é estudada aqui como um grafo no qual os nós correspondem a resíduos de aminoácidos individuais e as arestas representam ligações não covalentes entre eles, a partir de dados estraídos da base de dados [RCSB](https://www.rcsb.org/structure/1TUP). Para esse estudo, foi usada a biblioteca NetworkX e o software Gephi. 
